...
const TestimonialsColumn = (props: {className?:string, testimonials: typeof testimonials}) => (
          <div
            className= {twMerge("flex flex-col gap-6 items-center mt-10", props.className)}
            style={{
              WebkitMaskImage:
            ...
            {props.testimonials.map((testimonial, index) => (
              <div
                className="card p-6 shadow-lg rounded-lg border border-gray-200 bg-white"
                key={index}
              >
  ...
  return (
    <section className="bg-white">
      <div className="container mx-auto px-4">
        ...
        <h2 className="section-title mt-5 text-center">What our users say</h2>
        <p className="section-text mt-5 text-center">
